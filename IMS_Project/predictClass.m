...
[pred1, ~, prob1] = svmpredict(truth(1), hist, classifiers(1));
[pred2, ~, prob2] = svmpredict(truth(2), hist, classifiers(2));
[pred3, ~, prob3] = svmpredict(truth(3), hist, classifiers(3));
[pred4, ~, prob4] = svmpredict(truth(4), hist, classifiers(4));
